...
using System.Data; // Imports the MVC namespace, which provides the foundation for building web APIs.
...
namespace WebApplication1.Controllers // Declares a namespace to organize your controllers.
{
    ...
    public class ProductsController : ControllerBase // Defines the ProductsController class, inheriting from ControllerBase to handle HTTP requests.
    {
        private readonly string connectionString; // Declares a private string variable to store the database connection string.
        public ProductsController(IConfiguration configuration) // Constructor for the ProductsController, taking an IConfiguration object as a parameter.
        {
